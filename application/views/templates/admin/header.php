      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="<?php echo base_url();?>posts/admin_index">All Posts</a>
            </li>
            <li>
           <a href="<?php echo base_url();?>posts/create">Add Posts</a>
            </li>
          </ul>

          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="sliders">
          <a class="nav-link" href="<?php echo base_url(); ?>sliders/index">
